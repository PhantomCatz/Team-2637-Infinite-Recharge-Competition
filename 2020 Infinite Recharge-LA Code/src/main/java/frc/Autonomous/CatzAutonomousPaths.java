...
public class CatzAutonomousPaths
{
    ...
    public final static double DRIVE_TO_TIMEOUT   = 4000.0;
    public final static double DRIVE_BACK_TIMEOUT = 4000.0;
    ...
    public static void monitorAutoState(String position) 
    {
        ...
        {
           // System.out.println("Monitor autostate: " + position);
            if(!done)
            {
                switch (autoState) 
                {
                    ...
                    case AS_DRIVETO:
                        goalMet = auton.monitorEncoderPosition(autoTimer, DRIVE_TO_TIMEOUT);
                    ...
                    case AS_SHOOT:
                        ...
                        if (Robot.shooter.getShooterDoneState() == true)//.shooter.shooterState == Robot.shooter.SHOOTER_STATE_OFF) 
                        {
                    ...
                    case AS_DRIVEBACK:
                        goalMet = auton.monitorEncoderPosition(autoTimer , DRIVE_BACK_TIMEOUT);
