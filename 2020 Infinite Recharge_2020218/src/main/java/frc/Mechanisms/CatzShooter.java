...
public class CatzShooter
{
    ...
    public final int SHOOT_IDLE_MODE        = 0;
    public final int SHOOT_FROM_TARGET_ZONE = 1;
    public final int SHOOT_FROM_START_LINE  = 2;

   
    final double SHOOTER_TARGET_VEL_TARGET_ZONE_RPM = 4000.0; //TBD
    final double SHOOTER_TARGET_VEL_START_LINE_RPM  = 4300.0; //RPM
 
    final double SHOOTER_BANG_BANG_MAX_RPM_OFFSET = 20.0; 
    final double SHOOTER_BANG_BANG_MIN_RPM_OFFSET = 20.0;
    ...
    public void setShooterVelocity(int shootingPosition)
    {
        ...
        //System.out.println(Robot.dataCollectionTimer.get() );
