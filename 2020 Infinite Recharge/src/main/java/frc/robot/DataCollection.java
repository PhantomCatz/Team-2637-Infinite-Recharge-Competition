...
public class DataCollection 
{
    ...
    public void collectData(final int dataType)
    {
        CatzLog data;
        double data1 = 0.0;
        double data2 = 0.0;
        ...
        switch (dataType) 
        {
            case 1 :
                ...
                data2 = Robot.pdp.getCurrent(0);
                data3 = Robot.pdp.getCurrent(1);
                data4 = Robot.pdp.getCurrent(14);
                data5 = Robot.pdp.getCurrent(15);
                ...
                data10 = Robot.driveTrain.getSrxMagLT();
                data11 = Robot.driveTrain.getSrxMagRT();

                data12 = Robot.driveTrain.getInternaEncoderLT();
                data13 = Robot.driveTrain.getInternaEncoderRT();

                break;

            case 2 :
                data1 = Robot.driveTrain.getSrxMagLT();
                data2 = Robot.driveTrain.getSrxMagRT();
                break; 
        ...
        if(validValue == true) 
        {
            data = new CatzLog(Robot.t.get(), data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13);
