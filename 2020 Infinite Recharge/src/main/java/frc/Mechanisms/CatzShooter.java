...
public class CatzShooter {
    ...
    final double CONV_QUAD_VELOCITY_TO_RPM = (((ENCODER_SAMPLE_PERIOD_MSEC * MSEC_TO_SEC * SEC_TO_MIN)
            / COUNTS_PER_REVOLUTION)); // converts velocity to RPM
    ...
    public static final int SHOOTER_TEST_MODE = 6;
    ...
    private boolean shooterIsDone = false;
    ...
    public CatzShooter() // constructor
    {
        ...
        // equation which limits how long the ramp up goes (don't want it to go too
        // much/fast)
    ...
    {
        return (Math.abs((double) shtrMtrCtrlA.getSensorCollection().getQuadratureVelocity())
                * CONV_QUAD_VELOCITY_TO_RPM);
    }
    ...
    public void shoot() // when a button is pressed on controller, it will cause the indexer to move and
                        // launch balls. sets state to ready
    {
            ...
            while (true) {
                ...
                case SHOOTER_STATE_OFF: // when there is no targetRPM (basically when no button is pressed) will be
                    ...
                    if (targetRPM > 0.0) {
                        ...
                        System.out.println(
                                "T1: " + shootTime + " : " + flywheelShaftVelocity + " Power: " + shooterPower);
                    }

                    break;

                case SHOOTER_STATE_RAMPING: // once targetRPM is given, velocity ramps up as fast as possible to reach
                                            // targetRPM
                    ...
                    if (flywheelShaftVelocity > targetRPMThreshold) {
                        ...
                        shtrMtrCtrlA.set(shooterPower);
                        System.out.println(
                                "T2: " + shootTime + " : " + flywheelShaftVelocity + " Power: " + shooterPower);
                ...
                case SHOOTER_STATE_SET_SPEED: // making bang bang work. adds up RPM (prerequisite for bang bang, checks
                                              // average of )
                ...
                case SHOOTER_STATE_START_SHOOTING:
                    ...
                    if (flywheelShaftVelocity > targetRPM + SHOOTER_RPM_START_OFFSET) {
                        ...
                        System.out.println(
                                "TS2: " + shootTime + " : " + flywheelShaftVelocity + " Power: " + shooterPower);
                    }
                    break;

                case SHOOTER_STATE_WAIT_FOR_SHOOT_DONE: // will count for a certain amount of time until it switches the
                                                        // shooter off and sets state to OFF
                    ...
                    if (indexerShootStateCount > indexerShootStateCountLimit) {
                        ...
                        Robot.indexer.setShooterIsRunning(false);
                        System.out.println(
                                "TS4: " + shootTime + " : " + flywheelShaftVelocity + " Power: " + shooterPower);
                    }
